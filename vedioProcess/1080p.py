...
if __name__ == "__main__":
    ...
    if (1 == 11):
        ...
        ##下载歌曲
        mp3_paths = [
            "https://www.bilibili.com/video/BV1HQ4y1w71f/?spm_id_from=333.337.search-card.all.click&vd_source=8451966041ec52beb0f6936ba54722e8"]

        # 指定目录输出
        for i in mp3_paths:
            # extract_bgm(i,output_dir="./biblMusic")
            extract_bgm(i, output_dir="../output")
